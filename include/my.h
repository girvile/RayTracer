...
** Last update Wed Mar 15 16:57:42 2017 virgile
*/
...
void			my_draw_objects(t_data *d);
float			my_int_plan(sfVector3f eye_pos,		\
				     sfVector3f obj, sfVector3f dir_vector);
float			my_int_sphere(sfVector3f eye_pos,		\
				      sfVector3f obj, sfVector3f dir_vector, float radius);
float			my_int_cone(sfVector3f eye_pos,			\
				    sfVector3f obj, sfVector3f dir_vector, float angle);
float			my_int_cyl(sfVector3f eye_pos,			\
				   sfVector3f obj, sfVector3f dir_vector, float radius);
